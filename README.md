...
Includes explainability methods for DNABERT-2, including: Perturbation-based explanation and SHAP (SHapley Additive exPlanations). We adopted TranSHAp (https://github.com/enjakokalj/TransSHAP) for DNA sequence classification by
